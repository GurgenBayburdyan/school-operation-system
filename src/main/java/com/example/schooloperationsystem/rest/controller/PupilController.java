...
public class PupilController {
    ...
    public ResponseEntity<List<PupilDetailsDto>> getPupils() {
        ...
        ResponseEntity<List<PupilDetailsDto>> responseEntity = ResponseEntity.ok(pupilFacade.getPupils());
    ...
    public ResponseEntity<PupilDetailsDto> create(@RequestBody CreatePupilRequestDto requestDto) {
        ...
        ResponseEntity<PupilDetailsDto> responseEntity = ResponseEntity.ok(pupilFacade.addPupil(requestDto));
    ...
    public ResponseEntity<PupilDetailsDto> deleteById(@PathVariable("id") Long id) {
        ...
        ResponseEntity<PupilDetailsDto> responseEntity = ResponseEntity.ok(pupilFacade.deletePupilById(id));
    ...
    public ResponseEntity<List<PupilDetailsDto>> getBySchoolId(@PathVariable("schoolId") Long schoolId) {
        ...
        ResponseEntity<List<PupilDetailsDto>> responseEntity = ResponseEntity.ok(pupilFacade.getPupilsBySchoolId(schoolId));
